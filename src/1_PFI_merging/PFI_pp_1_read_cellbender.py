...
# # parser.add_argument("sample_name", help="Name of sample (folder in cellbender outputs)")
# parser.add_argument("indir", help="folder of cellbender outputs")
# parser.add_argument("outdir", help="folder to save processed .h5ad")
...
# if args.sample_name in os.listdir(args.indir):
#     read_cellbender_files(args.sample_name, args.indir, args.outdir)
# else:
#     print("{s} is not in {i}".format(s=args.sample_name, i=args.indir))
