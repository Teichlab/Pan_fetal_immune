...
# metadata["file"] = metadata["Sample.lanes"]
# obs_names = merged_adata.obs_names.copy()
# merged_adata.obs = pd.merge(merged_adata.obs, metadata, on="file")
# merged_adata.obs_names = obs_names
