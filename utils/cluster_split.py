...
start=time.time()
if no_labels:
    panfetal_utils.ridge_regression(sdata_pp, batch_key=['method','donor','organ'],confounder_key=[])
else:
    panfetal_utils.ridge_regression(sdata_pp, batch_key=['method','donor','organ'],confounder_key=['uniform_label_propagated'])
